...
<head>
	...
	<!-- Bootstrap -->
	<link rel="stylesheet" href="http://localhost:3408/demo/resources/sass/bootstrap.min.css">
	<!-- Template styles-->
	<link rel="stylesheet" href="http://localhost:3408/demo/resources/sass/style.css">
	<!-- Responsive styles-->
	<link rel="stylesheet" href="http://localhost:3408/demo/resources/sass/responsive.css">
	<!-- FontAwesome -->
	<link rel="stylesheet" href="http://localhost:3408/demo/resources/sass/font-awesome.min.css">
	<!-- Owl Carousel -->
	<link rel="stylesheet" href="http://localhost:3408/demo/resources/sass/owl.carousel.min.css">
	<link rel="stylesheet" href="http://localhost:3408/demo/resources/sass/owl.theme.default.min.css">
	<!-- Colorbox -->
	<link rel="stylesheet" href="http://localhost:3408/demo/resources/sass/colorbox.css">
...
<body>
			...
			<div class="row">
				<div class="col-md-3 col-sm-12">
					<div class="logo">
						 <a href="index.blade.php">
							<img src="http://localhost:3408/demo/resources/images/logos/logo.png" alt="">
						 </a>
					</div>
				</div><!-- logo col end -->
				...
				<div class="col-md-9 col-sm-12 header-right">
					<div class="ad-banner float-right">
						<a href="#"><img src="http://localhost:3408/demo/resources/images/banner-ads/ad-top-header.png" class="img-fluid" alt=""></a>
					</div>
							...
							<ul class="nav navbar-nav">
								<li class="nav-item dropdown active">
									...
									<ul class="dropdown-menu" role="menu">
										<li class="active"><a href="index.blade.php">Home 1</a></li>
									</ul>
								</li>
										      ...
										      <div class="tab-pane fade show active" id="tab-A">
										      	<div class="row">
										      		<div class="col-md-3">
											      		...
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/health1.jpg" alt="" /></a>
																</div>
										      		...
										      		<div class="col-md-3">
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/health2.jpg" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Health</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
										      		...
										      		<div class="col-md-3">
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/resources/images/news/lifestyle/health3.jpg" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Health</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
										      		...
										      		<div class="col-md-3">
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/health4.jpg" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Health</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
									        ...
									        <div class="tab-pane animated fadeIn" id="tab-B">
									        	<div class="row">
									        		<div class="col-md-3">
									        			<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/travel1.jpg" alt="" /></a>
																</div>
									        		...
									        		<div class="col-md-3">
									        			<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/travel2.jpg" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Travel</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
									        		...
									        		<div class="col-md-3">
									        			<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/travel3.jpg" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Travel</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
									      		...
									      		<div class="col-md-3">
									      			<div class="post-block-style clearfix">
														<div class="post-thumb">
															<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/travel4.jpg" alt="" /></a>
														</div>
														<a class="post-cat" href="#">Travel</a>
														<div class="post-content">
												 			<h2 class="post-title title-small">
											     ...
											     <div class="row">
											     		<div class="col-md-3">
											     			<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/food1.jpg" alt="" /></a>
																</div>
											     		...
											     		<div class="col-md-3">
											     			<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/food2.jpg" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Food</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
											     		...
											     		<div class="col-md-3">
											     			<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/food3.jpg" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Food</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
											     		...
											     		<div class="col-md-3">
											      		...
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/food4.jpg" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Food</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
										...
										<div class="mega-menu-content-inner">
											<div class="row">
								      		<div class="col-md-3">
									      		<div class="post-block-style clearfix">
														<div class="post-thumb">
															<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/video/video4.jpg" alt="" />
								      		...
								      		<div class="col-md-3">
									      		<div class="post-block-style clearfix">
														<div class="post-thumb">
														   <img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/video/video3.jpg" alt="" />
								      		...
								      		<div class="col-md-3">
									      		<div class="post-block-style clearfix">
														<div class="post-thumb">
														   <img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/video/video2.jpg" alt="" />
								      		...
								      		<div class="col-md-3">
									      		<div class="post-block-style clearfix">
														<div class="post-thumb">
														   <img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/video/video1.jpg" alt="" />
															<a class="popup" href="https://www.youtube.com/embed/DQNDcxRo-2M?autoplay=1&amp;loop=1">
														      <div class="video-icon">
														      	<i class="fa fa-play"></i>
														   	</div>
			...
			<div class="row">
				<div class="col-lg-7 col-md-12 pad-r">
					<div id="featured-slider" class="owl-carousel owl-theme featured-slider">
						<div class="item" style="background-image:url(http://localhost:3408/demo/resources/images/news/lifestyle/health5.jpg)">
						...
						<div class="item" style="background-image:url(http://localhost:3408/demo/resources/images/news/tech/gadget2.jpg)">
							<div class="featured-post">
						 		<div class="post-content">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="post-overaly-style contentTop hot-post-top clearfix">
								<div class="post-thumb">
									<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/gadget4.jpg" alt="" /></a>
								</div>
								<div class="post-content">
						 			<a class="post-cat" href="#">Gadget</a>
							...
							<div class="item">
								<ul class="list-post">
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/health5.jpg" alt="" /></a>
											</div>
											<a class="post-cat" href="#">Health</a>
											<div class="post-content">
									 			<h2 class="post-title title-medium">
							...
							<div class="item">
								...
								<ul class="list-post">
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/travel5.jpg" alt="" /></a>
											</div>
											<a class="post-cat" href="#">Travel</a>
											<div class="post-content">
									 			<h2 class="post-title title-medium">
							...
							<div class="item">
								...
								<ul class="list-post">
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/gadget2.jpg" alt="" /></a>
											</div>
											<a class="post-cat" href="#">Gadget</a>
											<div class="post-content">
									 			<h2 class="post-title title-medium">
									...
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/architecture3.jpg" alt="" /></a>
											</div>
								...
								<ul class="list-post">
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/food3.jpg" alt="" />
												</a>
											</div>
											<a class="post-cat" href="#">Food</a>
											<div class="post-content">
									...
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/game1.jpg" alt="" />
												</a>
											</div>
					      	...
					      	<div class="row">
						      	<div class="col-lg-6 col-md-6">
						      		<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/gadget1.jpg" alt="" />
												</a>
											</div>
											...
											<ul class="list-post">
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/gadget2.jpg" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/gadget3.jpg" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/gadget4.jpg" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/gadget5.jpg" alt="" />
															</a>
														</div><!-- Post thumb end -->
											...
											<ul class="list-post">
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/game2.jpg" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/game3.jpg" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/game4.jpg" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/game5.jpg" alt="" />
															</a>
														</div><!-- Post thumb end -->
								...
								<div class="row">
						      	<div class="col-lg-6 col-md-6">
						      		<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/robot1.jpg" alt="" />
												</a>
											</div>
											...
											<ul class="list-post">
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/robot2.jpg" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/robot3.jpg" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/robot4.jpg" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/robot5.jpg" alt="" />
															</a>
														</div><!-- Post thumb end -->
						...
						<div class="row">
							<div class="col-lg-6 col-md-6">
								<div class="post-overaly-style clearfix">
									<div class="post-thumb">
										<a href="#">
											<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/travel1.jpg" alt="" />
										</a>
									</div>
									...
									<ul class="list-post">
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/food1.jpg" alt="" />
													</a>
													<a class="post-cat" href="#">Food</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/health1.jpg" alt="" />
													</a>
													<a class="post-cat" href="#">Health</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/travel2.jpg" alt="" />
													</a>
													<a class="post-cat" href="#">Travel</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/architecture2.jpg" alt="" />
													</a>
													<a class="post-cat" href="#">Architecture</a>
												</div><!-- Post thumb end -->
							...
							<div class="col-lg-6 col-md-6">
								<div class="post-overaly-style last clearfix">
									<div class="post-thumb">
										<a href="#">
											<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/architecture3.jpg" alt="" />
										</a>
									</div>
									...
									<ul class="list-post">
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/health2.jpg" alt="" />
													</a>
													<a class="post-cat" href="#">Health</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/food2.jpg" alt="" />
													</a>
													<a class="post-cat" href="#">Food</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/architecture1.jpg" alt="" />
													</a>
													<a class="post-cat" href="#">Architecture</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/travel5.jpg" alt="" />
													</a>
													<a class="post-cat" href="#">Travel</a>
												</div><!-- Post thumb end -->
					...
					<div class="sidebar sidebar-right">
						...
						<div class="widget color-default">
							...
							<div class="post-overaly-style clearfix">
								<div class="post-thumb">
									<a href="#">
										<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/health4.jpg" alt="" />
									</a>
								</div>
						...
						<div class="widget text-center">
							<img class="banner img-fluid" src="http://localhost:3408/demo/resources/images/banner-ads/ad-sidebar.png" alt="" />
						</div><!-- Sidebar Ad end -->
							...
							<div id="post-slide" class="owl-carousel owl-theme post-slide">
								...
								<div class="item">
									...
									<div class="post-overaly-style text-center clearfix">
									   <div class="post-thumb">
									      <a href="#">
									         <img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/health5.jpg" alt="" />
									      </a>
									   </div><!-- Post thumb end -->
	...
	<section class="ad-content-area text-center no-padding">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<img class="img-fluid" src="http://localhost:3408/demo/resources/images/banner-ads/ad-content-one.jpg" alt="" />
				</div><!-- Col end -->
			</div><!-- Row end -->
		</div><!-- Container end -->
							...
							<ul class="list-post">
								...
								<li class="clearfix">
									<div class="post-block-style post-float clearfix">
										<div class="post-thumb">
											<a href="#">
												<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/travel3.jpg" alt="" />
											</a>
										</div><!-- Post thumb end -->
								...
								<li class="clearfix">
									<div class="post-block-style post-float clearfix">
										<div class="post-thumb">
											<a href="#">
												<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/travel4.jpg" alt="" />
											</a>
										</div><!-- Post thumb end -->
							...
							<ul class="list-post">
								...
								<li class="clearfix">
									<div class="post-block-style post-float clearfix">
										<div class="post-thumb">
											<a href="#">
												<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/health3.jpg" alt="" />
											</a>
										</div><!-- Post thumb end -->
								...
								<ul class="list-post review-post-list">
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/review/review1.jpg" alt="" />
												</a>
											</div><!-- Post thumb end -->
									...
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/review/review2.jpg" alt="" />
												</a>
											</div><!-- Post thumb end -->
									...
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/review/review3.jpg" alt="" />
												</a>
											</div><!-- Post thumb end -->
									...
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/review/review4.jpg" alt="" />
												</a>
											</div><!-- Post thumb end -->
	...
	<section class="ad-content-area text-center">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<img class="img-fluid" src="http://localhost:3408/demo/resources/images/banner-ads/ad-content-two.png" alt="" />
				</div><!-- Col end -->
			</div><!-- Row end -->
		</div><!-- Container end -->
				...
				<div class="row">
					...
					<div class="col-lg-3 col-sm-12 footer-widget">
						...
						<div class="gallery-widget">
							...
							<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/food3.jpg" alt="" /></a>
							<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/travel4.jpg" alt="" /></a>
							<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/architecture1.jpg" alt="" /></a>
							<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/gadget1.jpg" alt="" /></a>
							<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/gadget2.jpg" alt="" /></a>
							<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/game2.jpg" alt="" /></a>
							<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/tech/robot5.jpg" alt="" /></a>
							<a href="#"><img class="img-fluid" src="http://localhost:3408/demo/resources/images/news/lifestyle/travel5.jpg" alt="" /></a>
						</div>
					</div><!-- Col end -->
					...
					<div class="col-md-12">
						<div class="footer-info-content">
							<div class="footer-logo">
								<img class="img-fluid" src="http://localhost:3408/demo/resources/images/logos/footer-logo.png" alt="" />
							</div>
				...
				<div class="row">
					<div class="col-sm-12 col-md-6">
						<div class="copyright-info">
							<span>Copyright © 2018 News247 All Rights Reserved. </span>
						</div>
					</div>
	...
	<script type="text/javascript" src="http://localhost:3408/demo/resources/js/jquery.js"></script>
	<!-- Popper Jquery -->
	<script type="text/javascript" src="http://localhost:3408/demo/resources/js/popper.min.js"></script>
	<!-- Bootstrap jQuery -->
	<script type="text/javascript" src="http://localhost:3408/demo/resources/js/bootstrap.min.js"></script>
	<!-- Owl Carousel -->
	<script type="text/javascript" src="http://localhost:3408/demo/resources/js/owl.carousel.min.js"></script>
	<!-- Color box -->
	<script type="text/javascript" src="http://localhost:3408/demo/resources/js/jquery.colorbox.js"></script>
	<!-- Smoothscroll -->
	<script type="text/javascript" src="http://localhost:3408/demo/resources/js/smoothscroll.js"></script>


	<!-- Template custom -->
	<script type="text/javascript" src="http://localhost:3408/demo/resources/js/custom.js"></script>
